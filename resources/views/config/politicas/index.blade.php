...
@section('content')
    ...
    <div class="row pb-5">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-9 col-md-12 col-sm-12 col-12 mx-auto text-center my-3">
			<div class="card">
				<form action="{{ route('politicas.update', $politicas[6]->id) }}" method="post" class="card-body">
					@csrf
					@method('put')
					<label for="descripcion" class="fs-3 fw-bolder py-2">{{$politicas[6]->titulo}}</label>
					<textarea class="form-control summernote" name="descripcion" id="descripcion" rows="10">{{$politicas[6]->descripcion}}</textarea>
					<div class="form-group text-center mt-3">
						<button type="submit" class="btn btn-primary w-100 rounded-0">Guardar</button>
					</div>
				</form>
